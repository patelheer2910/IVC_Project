# main_pipeline_pytorch.py - Main script to run the PyTorch pipeline
import os
import sys

# Import our PyTorch modules
from feret_dataset import FERETDatasetPreparation
from train_snlf_pytorch import OptimizedTrainer
...
def main():
    ...
    TEST_DATA_PATH = 'test_data_700.csv'
    ...
    print(f"- Training history plot: training_history_pytorch.png")
    
    # Note about testing
    print("\nNext steps:")
    print("1. Use test_snlf_pytorch.py to evaluate the model on the test set")
